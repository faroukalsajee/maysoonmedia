    ...
    return (
        <div className="min-h-screen bg-[#F5F5F5] flex flex-col items-center justify-center px-4 py-12">
            <header className="flex flex-col items-center mb-12">
                ...
                <h1 className="text-3xl md:text-5xl font-bold tracking-tight text-gray-900 text-center mb-2">Our Services</h1>
            ...
            <section className="w-full max-w-6xl">
                ...
                <div className="mt-16 text-center">
                    ...
                    <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                        Maysoon Media is now <a href="https://rhythmi.ai" className="text-blue-600 hover:underline font-medium" target="_blank" rel="noopener noreferrer">rhythmi.ai</a>.
